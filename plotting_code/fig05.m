...
load('../data/MainAgeV2_flank_div_output_5001.mat') % divide and flank flow models
...
%% DEFINE VARIABLES FOR AGE-DEPTH FIG
    ...
    % Age_th = inverse model output from thinning scenario
...
known_ages = [2380, 4860]; % updated IRH ages from Sigl et al., 2014.
irh_err = [0.005, 0.02]; % error in IRH ages from Bodart et al., 2021
irh_err_d = [12.85, 15.52]; % uncertainties based on IRH depth at ice core 


%% FIGURE 5 - PLOT MAIN AGE DEPTH FIG WITH INSETS

main_age_depth_plot(Age_p1, Age_p5, Age_mean, div_age, flank_age, ...
                Age_p1_basal_melt_20mmyr, Age_p1_basal_melt_10mmyr, ...
                AgeData, Age_th, DepthData, known_ages, irh_err_d, irh_err, ...
