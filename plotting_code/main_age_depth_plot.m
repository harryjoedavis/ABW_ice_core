function main_age_depth_plot(Age_p1, Age_p5, Age_mean, div_age, flank_age, ...
    ...
    % main plot
    figure; hold all;
    [div, flank, h, basal10, basal, bed, oldest, hdata, irhs, th] = plot_age_depth_profiles(...
    ...
    box on; 
    grid on;
    legend([div; flank; h; basal10; basal; th; bed; oldest; hdata; irhs], ...
           'Forward model: divide flow', 'Forward model: flank flow', ...
           'Optimised model (1\leqp\leq5)', 'Basal melt = 10 mm/yr', 'Basal melt = 20 mm/yr','Thinning Scenario', ...
