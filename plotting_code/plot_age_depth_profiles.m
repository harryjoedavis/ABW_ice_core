function [div, flank, h, basal10, basal, bed, oldest, hdata, irhs, th] = plot_age_depth_profiles(...
    ...
    th = plot(Age_th/1e3, H-z, 'k', 'linewidth', 2); % constant accumulation and thinning
